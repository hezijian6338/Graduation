...
public class Graduate extends DataEntity<Graduate> {
	...
	private String graCertificate;     //毕业证
	private String degreeCertificate;   //学士学位证
	...
	@Length(min=0, max=50, message="毕业证信息长度必须介于 0 和 50 之间")
	public String getGraCertificate() {
		return graCertificate;
	}

	public void setGraCertificate(String graCertificate) {
		this.graCertificate = graCertificate;
	}

	@Length(min=0, max=50, message="学士学位长度必须介于 0 和 50 之间")
