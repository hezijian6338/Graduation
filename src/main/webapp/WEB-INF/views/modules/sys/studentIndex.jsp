...
<head>
    ...
    <style type="text/css">
        ...
        #studentControl>li>a{/*color:#fff;*/text-shadow:none;} #studentControl>li>a:hover, #student #studentControl>li.open>a{background:transparent;}
    </style>
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#studentInfo .dropdown-menu a").mouseup(function(){
...
<div id="main">
    <div id="header" class="navbar navbar-fixed-top">
        <div class="navbar-inner">
            ...
            <ul id="studentControl" class="nav pull-right">
                ...
                <li id="studentInfo" class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="${ctx}/sys/student/info" target="mainFrame"><i class="icon-user"></i>&nbsp; 个人信息</a></li>
                        <li><a href="${ctx}/sys/student/modifyPwd" target="mainFrame"><i class="icon-lock"></i>&nbsp;  修改密码</a></li>
            ...
            <div class="nav-collapse">
                <ul id="menu" class="nav" style="*white-space:nowrap;float:none;">
                    ...
                    <c:forEach items="${fns:getStudentMenuList()}" var="menu" varStatus="idxStatus">
